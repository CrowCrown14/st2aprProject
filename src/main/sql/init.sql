...
--
-- Hôte : db
-- Généré le : dim. 12 mars 2023 à 20:03
...
INSERT INTO `Intern` (`internId`, `nom`, `prenom`, `groupe`, `cdc`, `ficheVisite`, `sondageWeb`, `rapportRendu`, `soutenance`, `planifier`, `faite`, `debut`, `fin`, `entreprise`, `mdS`, `adresse`, `noteTechnique`, `noteCommunication`, `descriptionMission`, `commentaire`, `tutorUsername`) VALUES
(1, 'Alex', 'Xu', 'M2', 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'test'),
(2, 'Alex', 'Picard', 'M2', 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'test'),
(3, 'Theo', 'Koel', 'M2', 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'test'),
(4, 'Yoann', 'Losco', 'M2', 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'test'),
(5, 'Maxime', 'Fotso', 'M2', 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'test');
